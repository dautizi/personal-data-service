...
/**
 * Converter between {@link Adventure} and {@link com.danieleautizi.model.entity.Adventure}.
 */
@UtilityClass
public class AdventureConverter {

    public static com.danieleautizi.model.entity.Adventure presentationToEntity(final Adventure adventure) {

        return adventure == null
               ? null
               : com.danieleautizi.model.entity.Adventure.builder()
    ...
    public static Adventure entityToPresentation(final com.danieleautizi.model.entity.Adventure adventureEntity) {
    ...
    public static List<Adventure> entitiesToPresentation(final List<com.danieleautizi.model.entity.Adventure> adventureEntities) {
