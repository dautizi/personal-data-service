...
/**
 * Converter between {@link Article} and {@link com.danieleautizi.model.entity.Article}.
 */
@UtilityClass
public class ArticleConverter {

    public static com.danieleautizi.model.entity.Article presentationToEntity(final Article article) {

        return article == null
               ? null
               : com.danieleautizi.model.entity.Article.builder()
    ...
    public static Article entityToPresentation(final com.danieleautizi.model.entity.Article articleEntity) {
    ...
    public static List<Article> entitiesToPresentation(final List<com.danieleautizi.model.entity.Article> articleEntities) {
